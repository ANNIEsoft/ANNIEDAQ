...
//		~Lecroy3377();
		...
		void PrintRegister();			//Print Register vars	COMMON STOP
		void GetRegister();			//Retrieve register 	COMMON STOP
		void SetRegister();			//Send register parameters	COMMON STOP
		void EncRegister();			//Register control Encoder	COMMON STOP
		void DecRegister();			//Register control Decoder	COMMON STOP
