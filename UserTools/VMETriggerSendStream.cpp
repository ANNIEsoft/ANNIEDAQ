#include "VMETriggerSendStream.h"

VMETriggerSendStream::VMETriggerSendStream():Tool(){}


bool VMETriggerSendStream::Initialise(std::string configfile, DataModel &data){
...
bool VMETriggerSendStream::Execute(){
...
*/     //////////////////////////////////////////////////
	...
	*(m_data->SoftTrigger)=m_soft;	

	sleep(2);
	m_data->triggered=true;
	// add to data model too
	/*if(m_soft &&  m_crate_num==1){
	  while(!m_data->Crate->Triggered()){
...
bool VMETriggerSendStream::Finalise(){
